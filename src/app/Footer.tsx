      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-x-12 gap-y-16 md:col-span-3 lg:grid-cols-6">
          <div className="col-span-2 md:col-span-2 lg:col-span-2 lg:pr-8">
            <div className="">
              <Image src={Logo} alt="fashion store" width={200} height={40} />
            </div>
            <p className="mt-7 text-base leading-relaxed text-muted-foreground">
              sit amet consectetur adipisicing elit. At incidunt tenetur
              expedita deserunt fuga quasi voluptate culpa, architecto qui
              suscipit.
            </p>
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <a
                  href="#"
                  title=""
                  className="flex text-muted-foreground transition-all duration-200 hover:text-primary focus:text-primary"
                >
                  {" "}
                  About{" "}
                </a>
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            ...
            <form action="#" method="POST" className="mt-6">
              ...
              <Button
                type="submit"
                size="lg"
                className="mt-3 inline-flex items-center justify-center rounded-md bg-pink-600 px-6 py-4 hover:bg-pink-500"
              >
                Subscribe
              </Button>
            </form>
