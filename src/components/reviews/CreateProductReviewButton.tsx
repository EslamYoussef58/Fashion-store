...
export default function CreateProductReviewButton({ product, loggedInMember, hasExistingReview }: CreateProductReviewButtonProps) {
    ...
    return (
        ...
        <Button onClick={() => setShowReviewDialog(true)}
            ...
            >
            {loggedInMember ? "Please write a review" : "Please login to write a review"}
        </Button>
...
function ReviewSubmittedDialog({ open, onOpenChange}: ReviewSubmittedDialogProps){
    return (
...
function ReviewAlreadyExistsDialog({ open, onOpenChange}: ReviewAlreadyExistsDialogProps){
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
