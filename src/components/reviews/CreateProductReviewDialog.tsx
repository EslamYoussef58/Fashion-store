        ...
        <div className="space-y-5">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <AddMediaButton onFileSelected={startUpload} 
              disabled={attachments.filter(a => a.state !== "failed").length >= 5} />
              </div>
...
function AttachmentPreview({
  ...
  return (
    <div className={cn("relative size-fit",
      ...
      {state === "failed" && (
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform" title="Failed to upload media">
